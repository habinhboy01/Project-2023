    ...
    <div id="main">
    		    ...
    		    <?php if( have_rows('list-about-company') ): ?>
    	            <?php while( have_rows('list-about-company') ): the_row(); 
    					...
    					<div class="col-lg-6 col-12">
    						<div class="content-about2" data-aos="fade-down" data-aos-duration="1000">
    	...
    	<div class="container about-company">
    		<div class="row about-company2">
    		    ...
    		    <div class="col-lg-6 col-12" data-aos="fade-down" data-aos-duration="1000">
				...
				<div class="col-lg-6 col-12" data-aos="fade-up" data-aos-duration="1000">
				   ...
				   <?php 
                    $image = get_field('img-about-company');
                    if( !empty( $image ) ): ?>
                        <img class="content-about" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
                    <?php endif; ?>
        ...
        <div class="container about-company">
    		<?php 
            $image = get_field('img-our-core-values');
            if( !empty( $image ) ): ?>
                <img class="content-about" src="<?php echo esc_url($image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" />
            <?php endif; ?>
        </div>
    			...
    			<div class="row">
    				...
    				<div class="col-lg-8 col-12">
    					<div class="content-solution5">
    						<div class="content-solution2 content-solution4" data-aos="zoom-in" data-aos-duration="2000">
    					            ...
    					            <?php while( have_rows('list-solution') ): the_row(); 
    					                ...
    					                ?>
    						                ...
    						                <div class="content-solution">
    						                	...
    						                	<div>
    								                <a href="<?php echo $link;?>" target="_blank" data-aos-duration="1000">
    						...
    						<div class="content-solution2 content-solution3" data-aos="zoom-in-up" data-aos-duration="1000">
    	...
    	<div class="container-fluid bg-technology">
    		...
    		<p class="text-technology2"><?php echo the_field('text-technology'); ?></p>
    	</div>
    			...
    			<div class="row bg-technology">
    				<?php if( have_rows('list-domain-expert') ): ?>
    		            <?php while( have_rows('list-domain-expert') ): the_row(); 
    		                ...
    		                <div class="col-lg-6 col-12" data-aos="zoom-in-up" data-aos-duration="2000">
    	...
    	<div class="bg-commitment">
    		<div class="container-fluid">
    			...
    			<div class="row bg-technology">
                    ...
                    <div class="col-lg-6 col-md-6 col-12" data-aos="fade-down" data-aos-duration="1000">

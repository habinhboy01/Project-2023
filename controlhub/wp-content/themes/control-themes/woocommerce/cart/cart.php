...
<div class="container">
    ...
    <p class="orderReview-title">Order Summary</p>
    <p class="orderReview-text">Review your order with <strong><?php echo WC()->cart->get_cart_contents_count() ?>
            item(s)</strong>
        and total <?php wc_cart_totals_order_total_html(); ?>
    </p>
</div>
                ...
                <td class="product-remove">
                    <?php
								echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
									...
									sprintf(
										'<a href="%s" class="remove" aria-label="%s" data-product_id="%s" data-product_sku="%s"><i class="far fa-trash-alt" style="color: #d62424;"></i></a>',

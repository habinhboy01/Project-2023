...
<div class="container">
    <div class="row prdetail">
        ...
        <div class="col-lg-6">
            <div class="product-detaill">
                ...
                <p><span>Manufacturer: </span> <?php echo get_the_term_list($product->get_id(), 'product_tag', '', ', '); ?></p>
                <p><span>SKU: </span> <?php echo $product->get_sku(); ?></p>
                <p><span>MPN: </span> <?php echo $product->get_sku(); ?></p>
    ...
    <div class="de-products">
        <div class="f-d-title">Product Details</div>

		...
		<div class="row">
			...
			<div class="col-lg-9 col-12">
				...
				<div class="bg-feedback">
					<div class="row bg-feedback2">
						<?php
				            $args = array(
		                        'post_type' => 'post',
		                        'posts_per_page' => 1,                      
		                        'post_status' => 'publish',
								'category_name' => 'cam-nhan-khach-hang',
								'order'  => 'date',
				            ); 
				        ?>
				            ...
				            <?php while ($getposts->have_posts()) : $getposts->the_post(); ?>
				            	...
				            	<div class="col-lg-4 col-md-4 col-12">
									<a class="img-feedback" href="<?php the_permalink(); ?>">
					...
					<?php if (have_posts()) : ?>
						<?php while (have_posts()) : the_post(); ?>
	                    	...
	                    	<div class="col-lg-4 col-md-6 col-12 fb">
	                    		<div class="content-feedback3">

	                    			<div class="text-news-home"><?php the_excerpt(); ?></div>
                                    
                                    <h1 class="name-customer"><?php the_title(); ?></h1>

									<div class="img-feedback2">
									    <?php the_post_thumbnail('full'); ?>
									</div>

								</div>

								<p class="detail-feedback"><a href="<?php the_permalink(); ?>">Xem thêm</a></p>
							</div>

...
<div id="comments" class="comments-area">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
	    ...
	    <?php endif; ?>
	     	<p>
	        	<textarea name="comment" id="comment" cols="50" rows="4" tabindex="4" placeholder="<?php _e('Nội dung','devvn')?>"></textarea>
	        </p>
	    <?php if(!is_user_logged_in()):?>    
	    ...
	    <?php endif;?>
	        <p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Bình luận','devvn')?>" />

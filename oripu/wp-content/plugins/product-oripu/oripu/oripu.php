...
add_action('init', 'custom_oripu');

// The custom function to register a movie post type
function custom_oripu()
{

    register_post_type('product-oripu', [
        'label' => __('Oripu', 'txtdomain'),
        'public' => true,
        'menu_position' => 5,
        ...
        'show_in_rest' => true,
        'rewrite' => ['slug' => 'product-oripu'],
        'taxonomies' => ['category-product'],
        'labels' => [
            'singular_name' => __('product-oripu', 'txtdomain'),
            'add_new_item' => __('Add new product oripu', 'txtdomain'),
            'new_item' => __('New product-oripu', 'txtdomain'),
            'view_item' => __('View product-oripu', 'txtdomain'),
            'not_found' => __('No product-oripu found', 'txtdomain'),
            'not_found_in_trash' => __('No product-oripu found in trash', 'txtdomain'),
            'all_items' => __('All Product Oripu', 'txtdomain'),
            'insert_into_item' => __('Insert into product-oripu', 'txtdomain')
        ],
    ]);

    // muc category

    register_taxonomy('category-product', ['product-oripu'], [
    ...
    register_taxonomy_for_object_type('category-product', 'product-oripu');
}
